...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 541px">
        ...
        <div style="border:1px solid black; width:650px; height: 415px; position:absolute; top:159px; left:429px;">
            ...
            <asp:Label ID="Label2" runat="server" Text="Password: " style="position:absolute; top:198px; left:115px;"></asp:Label>

            <asp:TextBox ID="tbPass" runat="server" style="position:absolute; top: 196px; left: 210px; width: 235px; height: 23px;"></asp:TextBox>
