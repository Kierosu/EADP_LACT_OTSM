<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddAutoNoti.aspx.cs" Inherits="AddAutoNoti" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="form-group row">
            <div class="col-lg-1"></div>
            <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn btn-outline-primary btn-rounded waves-effect col-lg-2" OnClick="btnAdd_Click"/>
